...
AudioOutputI2S    sound_out(0 /*port*/, AudioOutputI2S::INTERNAL_DAC ,32 /*dma_buf_count*/);
// AudioOutputI2S    sound_out(1 /*port*/, AudioOutputI2S::INTERNAL_DAC ,64 /*dma_buf_count*/);
...
void MP3::volume(uint8_t vol_percentage){
  _vol = constrain(vol_percentage,0,100);
  sound_out.SetGain(_vol/100.0);
}
